        ...
        <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
                ...
                <ul class="sidenav-second-level collapse" id="collapseViewCourse">
                    <li>
                        <a href="add course.php">Add</a>
                    </li>
                    <li>
                        <a href="search.php">Search</a>
                    </li>
                    <li>
                        <a href="add file.php">Provide course material</a>
                    </li>
                    <li>
                        <a href="add quiz.php">Create assignment</a>
                    </li>
                    <li>
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages">
                <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseBrowsePeople"
                   data-parent="#exampleAccordion">
                    <i class="fa fa-fw fa-user"></i>
                    <span class="nav-link-text">People</span>
                </a>
                <ul class="sidenav-second-level collapse" id="collapseBrowsePeople">
                    <li>
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages">
                <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseBrowseTeams"
                   data-parent="#exampleAccordion">
                    <i class="fa fa-fw fa-users"></i>
                    <span class="nav-link-text">Teams</span>
                </a>
                <ul class="sidenav-second-level collapse" id="collapseBrowseTeams">
                    <li>
                        <a href="register team.php">Register</a>
                    </li>
                </ul>
            </li>
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages">
                <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseLeaderBoard"
                   data-parent="#exampleAccordion">
