        ...
        <div class="container-fluid" style="padding: 10px 30px">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <i class="fa fa-area-chart"></i> Average Marks
                </div>
                <div class="card-body">
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <i class="fa fa-bar-chart"></i> Trainee's Engagement Level Tracker
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <i class="fa fa-pie-chart"></i> Priority Level for Each Course
                        </div>
                        <div class="card-body">
